...
def main(argv):
    ...
    argparser.add_argument("-w", "--working_path", dest="working_path", type=int, help="Cytomine id of the image to preocess")
    ...
    with CytomineJob.connect_from_cli(argv) as job:
